...
export type RelationFieldFragment = {
...
export function useDiagramQuery(
  baseOptions?: Apollo.QueryHookOptions<DiagramQuery, DiagramQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DiagramQuery, DiagramQueryVariables>(
    DiagramDocument,
    options,
  );
}
export function useDiagramLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DiagramQuery,
    DiagramQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DiagramQuery, DiagramQueryVariables>(
    DiagramDocument,
    options,
  );
}
...
export type DiagramQueryResult = Apollo.QueryResult<
  DiagramQuery,
  DiagramQueryVariables
>;
